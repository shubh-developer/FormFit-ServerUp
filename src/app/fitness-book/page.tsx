...
export default function FitnessBookPage() {
  return (
      ...
      <div className="relative flex items-center justify-center min-h-screen pt-28 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-light text-white mb-4 tracking-wide">Book Your Fitness Training</h1>
            <h2 className="text-2xl font-bold text-yellow-400 mb-4">
              FormaFit Personal Training
            </h2>
            <p className="text-gray-200">
              Fill out the form below to schedule your professional fitness training session
            </p>
          </div>
